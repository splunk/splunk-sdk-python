      ...
      "POST": {
        ...
        "params": {
          ...
          "maxDataSize": {
            ...
            "default": "auto", 
            "required": "false", 
            "summary": "The maximum size in MiB for a hot DB to reach before a roll to warm is triggered. Specifying \"auto\" or \"auto_high_volume\" causes Splunk to autotune this parameter (recommended).Use \"auto_high_volume\" for high volume indexes (such as the main index); otherwise, use \"auto\".  A \"high volume index\" would typically be considered one that gets over 10 GiB of data per day.\n* \"auto\" sets the size to 750 MiB.\n* \"auto_high_volume\" sets the size to 10 GiB on 64-bit, and 1 GiB on 32-bit systems.\n\nAlthough the maximum value you can set this is 1048576 MiB, which corresponds to 1 TiB, a reasonable number ranges anywhere from 100 - 50000. Any number outside this range should be approved by Splunk Support before proceeding.\n\nIf you specify an invalid number or string, maxDataSize will be auto-tuned.\n\nNOTE: The precise size of your warm buckets may vary from maxDataSize, due to post-processing and timing issues with the rolling policy.", 
          ...
          "maxMemMB": {
            ...
            "default": "5", 
            "required": "false", 
            "summary": "The amount of memory, expressed in MiB, to allocate for buffering a single tsidx file into memory before flushing to disk. Defaults to 5. The default is recommended for all environments.\n\nIMPORTANT: Calculate this number carefully. Setting this number incorrectly may have adverse effects on your systems memory and/or splunkd stability/performance.", 
          ...
          "maxTotalDataSizeMB": {
            ...
            "default": "500000", 
            "required": "false", 
            "summary": "The maximum size of an index (in MiB). If an index grows larger than the maximum size, the oldest data is frozen.", 
